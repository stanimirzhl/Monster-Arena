...
namespace Monster_Arena.Events
{
	public class GameEvents
	{
		...
		public delegate void CriticalHitHandler(Character attacker, Character target, int damage);
		...
		public static void RaiseCriticalHit(Character attacker, Character target, int damage)
		{
